    ...
    <div v-if="inviteSuccess" class="modal-overlay" @click="inviteSuccess = null">
      <div class="modal-content" @click.stop>
        ...
        <div class="success-content">
          <p>User <strong>{{ inviteSuccess.email }}</strong> has been added to your team.</p>
          
          <!-- Email sent successfully -->
          <div v-if="inviteSuccess.emailSent" class="success-box">
            <p>📧 <strong>An invitation email has been sent to {{ inviteSuccess.email }}</strong></p>
          ...
          <div v-else>
            <div class="warning-box" style="margin-bottom: 15px;">
              <strong>⚠️ Email Failed:</strong> The invitation email could not be sent. 
            ...
            <div class="temp-password-box">
              ...
              <div class="password-display">
                ...
                <button @click="copyPassword(inviteSuccess.tempPassword!)" class="btn-copy">Copy</button>
              </div>
            </div>

            <div class="info-box" style="margin-top: 15px;">
              Share this password with the new team member securely. 
              They should change it after their first login.
            </div>
          </div>
        </div>

        <button @click="inviteSuccess = null; showInviteModal = false" class="btn-primary">Close</button>
      </div>
    </div>
      ...
      <div class="modal-content" @click.stop>
        ...
        <form @submit.prevent="handleInvite" class="form">
          ...
          <div class="info-box">
            ...
            Make sure to share it with the new team member securely.
          </div>
