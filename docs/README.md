...
### Architecture & Design
- **[Architecture Overview](./architecture.md)** *(to be created)* - System design, data flow, and component interactions
- **[Decision Records](./decisions.md)** *(to be created)* - Architectural decisions and their rationale
