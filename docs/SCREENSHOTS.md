...
This document describes the UI patterns and design standards for the admin dashboard based on Hotjar's interface.
...
**Status:** ✅ Implemented (with radio enhancements)

**Recent Updates:**

-   Radio question enhancements: comment fields, randomization, pinned answers
-   Custom thank you message field
-   Hotjar-style UI for answer options
...
-   Question editor showing:
    ...
    -   Answer options list (Hotjar-style horizontal layout):
        -   Answer label (ANSWER 1, ANSWER 2, etc.)
        -   Text input field
        -   Comment icon button (toggle for "Enter comment when selecting this answer")
        -   Delete button (trash icon)
    -   Bottom controls row:
        -   "+ Add answer" button
        -   "Required question" checkbox
        -   "Randomize order" checkbox
        -   "Pin answer X to bottom" checkbox
    -   Thank you message section (after questions list)
