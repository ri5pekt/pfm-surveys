...
**Radio Question Enhancements (Implemented 2026-02-03):**

-   Per-answer "Enter comment when selecting this answer" option
-   Per-question "Randomize order" setting
-   "Pin answer to bottom" for keeping specific options last
-   Survey-level "Thank you message" customization
...
<script>
    (function () {
        ...
        script.src = "https://surveys.yourdomain.com/embed/script.js?site_id=SITE_ID";
        script.async = true;
...
-   Required toggle
-   **For radio questions:**
    -   "Randomize order" checkbox - shuffles answer options on display
-   Answer options list (for radio/checkbox):
    -   Text input per answer
    -   "Enter comment when selecting this answer" toggle (comment icon button)
    -   Delete answer button
    -   Drag handles for reordering (future)
-   **"Pin to bottom" checkbox** - appears after all answers for radio questions
-   "Add answer" button
-   **Thank you message section:**
    -   Textarea for custom thank you message (shown after survey submission)
